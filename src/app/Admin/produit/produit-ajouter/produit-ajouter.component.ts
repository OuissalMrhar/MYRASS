...
@Component({
  ...
  styleUrl: './produit-ajouter.component.scss',
})
  ...
  ngOnInit(): void {
    ...
    this.form.controls.categorieId.valueChanges.subscribe((cid) => {
      this.filteredCatalogues = cid
        ...
        : [];
      // emitEvent:false évite la cascade vers catalogueId.valueChanges → typeProduitId.valueChanges
