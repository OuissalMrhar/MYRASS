...
export class Accueil1Component implements OnInit, OnDestroy {
  ...
  giftImageUrl(gift: Gift): string {
    ...
    return fromProduit || 'https://res.cloudinary.com/dzajgsdwg/image/upload/f_auto,q_auto:eco,c_limit,w_900/v1777159305/ChatGPT_Image_26_avr._2026_00_20_16_styg3q.png';
  }
}
